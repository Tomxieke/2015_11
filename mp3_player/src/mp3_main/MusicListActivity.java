...
public class MusicListActivity extends Activity implements OnItemClickListener{
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		mIntent.putExtra("MUSIC_BEAN", m);
		mIntent.putParcelableArrayListExtra("MUSIC_BEAN_LIST", mMusicBeanList);
		mIntent.putExtra("MUSIC_POSSTION", arg2);
		int resultCode = 2;
